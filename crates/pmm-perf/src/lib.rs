...
use quote::quote;
use syn::{
    Expr, ExprLit, ItemFn, Lit, Meta, parse::Parser, parse_macro_input, punctuated::Punctuated,
    token::Comma,
};

#[proc_macro_attribute]
pub fn performance_log(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        #vis #sig {
            ...
            let mut log_path = ::pmm_utils::general::get_root_wd();
            log_path.push("logs");
